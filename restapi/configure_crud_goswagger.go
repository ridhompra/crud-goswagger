...
import (
	...
	"github.com/ridhompra/restapi/operations"
	"github.com/ridhompra/restapi/operations/health_check"
)

//go:generate swagger generate server --target ../../crud_goswagger --name CrudGoswagger --spec ../api/swagger.yml --principal interface{}
